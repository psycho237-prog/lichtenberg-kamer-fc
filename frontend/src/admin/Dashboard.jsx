            ...
            <div className="flex-grow ml-64 p-10">
                <header className="flex justify-between items-center mb-12">
                    <div>
                        ...
                        <p className="text-gray-500 font-bold uppercase tracking-widest text-xs mt-1">Gérer Lichtenberg-Kamer e.V</p>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="card-gradient rounded-3xl p-10 border border-white/5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <Link to="/lkev-admin/news" className="bg-white/5 hover:bg-primary-blue p-6 rounded-2xl transition-colors text-center group">
                                <span className="font-bold uppercase text-[10px] tracking-widest text-gray-400 group-hover:text-white">Publier Actuality</span>
                            </Link>
                            <Link to="/lkev-admin/players" className="bg-white/5 hover:bg-primary-blue p-6 rounded-2xl transition-colors text-center group">
                                <span className="font-bold uppercase text-[10px] tracking-widest text-gray-400 group-hover:text-white">Gestion Joueurs</span>
                            </Link>
                            <Link to="/lkev-admin/matches" className="bg-white/5 hover:bg-primary-blue p-6 rounded-2xl transition-colors text-center group">
                                <span className="font-bold uppercase text-[10px] tracking-widest text-gray-400 group-hover:text-white">Gérer Matchs</span>
                            </Link>
                            <Link to="/lkev-admin/gallery" className="bg-white/5 hover:bg-primary-blue p-6 rounded-2xl transition-colors text-center group">
                    ...
                    <div className="card-gradient rounded-3xl p-10 border border-white/5 flex flex-col justify-center items-center text-center">
                        ...
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] max-w-xs leading-relaxed">
                            Contenu dynamique : Accueil, Contact, et Paramètres globaux disponibles via le menu.
                        </p>
                    </div>
                </div>
            </div>
