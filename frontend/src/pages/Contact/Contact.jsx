                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="relative rounded-xl overflow-hidden h-48 md:h-96 grayscale contrast-125 border border-white/10 group">
                            <div
                                ...
                                dangerouslySetInnerHTML={{ __html: pageData?.mapIframe || '<iframe src="https://maps.google.com/maps?q=Coppistra%C3%9Fe%208%2C%2010365%20Berlin-Lichtenberg&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>' }}
                            />
