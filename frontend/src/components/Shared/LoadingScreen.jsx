            ...
            {isVisible && (
                ...
                >
                    ...
                    <motion.h2
                        ...
                        className="text-3xl md:text-5xl font-black italic text-white uppercase tracking-widest relative z-10"
                    >
                        Lichtenberg <span className="text-primary-yellow">Kamer FC</span>
                    </motion.h2>
